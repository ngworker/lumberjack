...
import { LumberjackDriver, LumberjackDriverLog, LumberjackLog, LumberjackLogPayload } from '@lumberjackjs/core';
  ...
  implements LumberjackDriver<TPayload>, OnDestroy
{
   ...
   *
   * When the last retry fails, the driver will throw a `LumberjackAngularHttpDriverError`
