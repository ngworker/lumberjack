...
description: Recommended patterns for structured logs with LumberjackLogger.
---
...
As seen in the [Log drivers](/lumberjack/log-drivers/overview/) section, we can send extra info to our drivers using
